...
fs = pd.read_csv('FS_final/Muskegon_fs_scores_HNA_5seq10.csv', index_col=0, header=0)
...
unique_scores_hna_RL_, r2_cv_hna_RL_ = get_r2_scores_Lasso(data_stand.loc[index,otus], hna_rel, otus, fs.loc[otus,'RL ranking'], cv, le_values)
...
unique_scores_hna_, r2_cv_hna_ = get_r2_scores_Lasso(data_stand.loc[index,otus], hna_rel, otus, fs.loc[otus,'Boruta ranking'], cv, le_values)
