...
### Write the tsv files
write.table(otu_table(physeq.otu.abs), file="data/absolute_otu.tsv", row.names=FALSE)
write.table(otu_table(physeq.otu.rel), file="data/relative_otu.tsv", row.names=FALSE)
write.table(sample_data(physeq.otu.rel)[,-1], file="data/HNA_LNA.tsv", row.names=FALSE)
write.table(tax_table(physeq.otu.rel), file="data/taxonomy_otu.tsv", row.names=FALSE)
```
