...
res_NA_5in10_fix <- dplyr::left_join(res_HNA_5in10_fix, scores_sb[, c(1:3, 5)], by = c("taxa" = "OTU"))
...
for(i in 1:3){
  ...
  ggtitle("Shared population")
    ...
    png(file = paste("FPcorSEQ_1in3_shared_notrans_", env[i], ".png", sep =""), width = 7, height = 6, 
...
png(file = paste("FPcorSEQ_1in3_unique_notrans_", env[i], ".png", sep =""), width = 20, height = 10, 
    units  = "in", res = 500, bg = "transparent")
...
png(file = paste("FPcorSEQ_5in10_unique_notrans_", env[i], ".png", sep =""), width = 20, height = 10, 
    units  = "in", res = 500, bg = "transparent")
grid_arrange_shared_legend(v_LNA_5in10_fix, v_HNA_5in10_fix, ncol = 2, position = "right")
dev.off()

png(file = paste("FPcorSEQ_5in10_shared_notrans_", env[i], ".png", sep =""), width = 7, height = 6, 
    units  = "in", res = 500, bg = "transparent")
